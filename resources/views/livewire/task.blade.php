                    ...
                    @foreach ( $tasks as $task )
                        <li class="flex items-center justify-between gap-x-6 py-5 cursor-grab" wire:key='task-{{ $task->id }}'>
                            ...
                            <div class="flex flex-none items-center gap-x-4">
                                ...
                                <svg wire:click='deleteTask({{ $task->id }})' wire:confirm='Are you sure you want to delelte this task?' class="text-red-500 w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
